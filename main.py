...
def attack(char_name: str, char_class: str) -> str:
    """Returns a string describing the attack."""
...
def special(char_name: str, char_class: str) -> str:
    """Returns a string describing the special skill."""
    if char_class == 'warrior':
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает строку с описанием защиты."""
    if char_class == 'warrior':
        return (f'{char_name} блокировал {10 + randint(1, 10)} ед. урона')
    if char_class == 'mage':
        return (f'{char_name} блокировал {10 + randint(1, 5)} ед. урона')
    if char_class == 'healer':
        return (f'{char_name} блокировал {10 + randint(1, 7)} ед. урона')
    return (f'{char_name} не смог отразить аттаку противника')
